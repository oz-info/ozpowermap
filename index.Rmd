...
In Australia, the party that gets to form government is the onewho wins the most seats in the House of Representatives, which comes down to winning the vote in the majority of federal electorates.
...
Or, to turn it around, if you live in one of those areas where one pub-full of people get to choose who wins, your vote is very important, and you have a representative who really needs your support to keep their job.
Next time you feel like the government is ignoring you, maybe you should consider moving to one of these _marginal seats_ and then see if your representative isn’t much more interested in hearing what you have to say.
(If that does help, let us know)

Let’s have a look at this on a map.
Here are the electorates from the 2019 Federal election, colourised by the size of the margin that the winning candidate had,
...
Light colours:
: Marginal seats. You probably have the power to influence policy and government.

Dark colours:
: Non marginal seats. Your representative thoroughly won, and there is likely not so much pressure on them to win over every last voter.
